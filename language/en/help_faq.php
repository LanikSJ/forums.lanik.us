...
$help = array(
	array(
					...
					0 => '--',
					1 => 'Malware/Ads Issues',
				),	array(
					0 => 'I have AdBlock/uBlock or another ad blocker installed yet I still see ads',
					1 => 'scan your system for malware / adware
use => <a href="https://www.malwarebytes.org">MalwareBytes AntiMalware (free version)</a>
and <a href="http://www.bleepingcomputer.com/download/adwcleaner/">AdwCleaner</a><br>
Courtesy of intense',
				),	array(
					0 => 'Why am I getting Amazon/Google/Yahoo etc ads with AdBlock?',
					1 => 'Please make sure <a href=https://adblockplus.org/acceptable-ads#optout>AdBlock Acceptable Ads</a> are turned off.',
				),	array(
					0 => '--',
					1 => 'Filters and Filter Sets',
				),	array(
					0 => 'How do I add a customer filter?',
					1 => 'Please follow <a href=https://adblockplus.org/forum/viewtopic.php?f=2&t=42013><b>THESE</b></a> instructions.',
				),	array(
					0 => 'How do I update my filters?',
					1 => 'If you\'re using AdBlock see directions <a href=https://help.getadblock.com/support/solutions/articles/6000055734-how-do-i-manually-update-my-filters-><b>HERE</b></a>.<br>
If you\'re using Adblock Plus see directions <a href=https://adblockplus.org/faq_basics#update-filterlists><b>HERE</b></a>.<br>
