...
$lang = array_merge($lang, [
	...
	'ACP_HELP_PHPBB'			=> 'Допомогти підтримувати phpBB',
	...
	'CONTAINER_EXCEPTION' => 'Виникла помилка phpBB при компіляції контейнера, пов\'язана з одним з встановлених розширень. З цієї причини, всі встановлені розширення було тимчасово вимкнено. Спробуйте очистити кеш форуму. Всі розширення буде автоматично увімкнено, коли помилку контейнера буде усунено. В протилежному випадку, зверніться на сайт офіційної української підтримки <a href="https://phpbb.com.ua/community/">phpBB українською</a> для отримання допомоги.',
	'EXCEPTION' => 'Виняток',
	...
	'REMIND'	=> 'Нагадати',
	'REPARSE_LOCK_ERROR'				=> 'Обробку вже розпочато іншим процесом.',
	...
	'UPDATE_NEEDED' => 'Форум потребує оновлення.',
	'UPDATE_NOT_NEEDED' => 'Форум останньої версії.',
...
$lang = array_merge($lang, [
   ...
   // Environment configuration checks, mbstring related
	...
	'PHP_VERSION'		=> 'Версія PHP',
 	'PHP_VERSION_OLD'	=> 'Версія PHP на цьому сервері (%1$s) більше не буде підтримуватись майбутніми версіями of phpBB. Мінімальна необхідна версія - PHP %2$s. %sДокладніше%s',
	...
	'VERSION_CHECK_EXPLAIN' => 'Перевіряє чи ваш форум phpBB останньої версії.',
	'VERSIONCHECK_INVALID_ENTRY' => 'Відомості про останню версію містять запис, який не підтримується.',
	'VERSIONCHECK_INVALID_URL' => 'Відомості про останню версію містять неправильне посилання.',
	'VERSIONCHECK_INVALID_VERSION' => 'Відомості про останню версію містять неправильне значення версії.',
	'VERSION_NOT_UP_TO_DATE_ACP' => 'Ваш форум phpBB не останньої версії.<br /> Нижче ви знайдете посилання на оголошення про вихід останньої версії, яке містить додаткову інформацію, а також інструкції по оновленню phpBB.',
	'VERSION_NOT_UP_TO_DATE_TITLE' => 'Ваш форум phpBB не останньої версії.',
	'VERSION_UP_TO_DATE_ACP' => 'Ваш форум phpBB останньої версії. На даний момент оновлення відсутні.',
...
$lang = array_merge($lang, [
	...
	'LOG_BBCODE_CONFIGURATION_ERROR'	=> '<strong>Помилка при налаштуванні BBCode</strong>: %1$s<br />» %2$s',
	...
	'LOG_RESTORE_TOPIC'			=> '<strong>Відновлено тему “%1$s”, створену </strong><br />» %2$s',
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>Помилка CAPTCHA</strong><br />В» %s',
