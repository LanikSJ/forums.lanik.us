...
$lang = array_merge($lang, [
	...
	'FILES_STATS_WRONG'		=> 'Схоже, що статистика вкладень недостовірна і потребує синхронізації. Актуальні дані: кількість вкладень = %1$d, загальний розмір вкладень = %2$s.<br />Натисніть %3$sтут%4$s, що синхронізувати їх.',
