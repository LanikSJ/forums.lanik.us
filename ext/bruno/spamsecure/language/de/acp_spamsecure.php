...
$lang = array_merge($lang, [
	...
	'SSPE_NO_LINKS'								=>	'Links verbieten',
	'SSPE_NO_LINKS_EXPLAIN'						=>	'Hier kannst du auswählen ob es möglich sein soll, Beiträge zu verfassen die Links enthalten. Wenn die Option <b>"JA"</b> gewählt ist wird es <b>(abhängig der Eingestellten Benutzer- bzw. Gruppenberechtigungen)</b> nicht möglich sein, Beiträge mit Links abzusenden.<br><br><b>Information:</b> Der Benutzer erhält eine entsprechende Fehlermeldung.',
	'SPSE_LANG_KYRILL'							=> 'Kyrillische Zeichen Verbieten',
	'SPSE_LANG_KYRILL_EXPLAIN'					=> 'Hier kannst du auswählen ob es möglich sein soll, Beiträge zu verfassen die kyrillische Zeichen enthalten. Wenn die Option <b>"JA"</b> gewählt ist wird es <b>(abhängig der Eingestellten Benutzer- bzw. Gruppenberechtigungen)</b> nicht möglich sein, Beiträge mit kyrillischen Zeichen abzusenden.<br><br><b>Information:</b> Der Benutzer erhält eine entsprechende Fehlermeldung.',
	'SPSE_LANG_CHINESE'							=> 'Chinesische Zeichen verbieten',
	'SPSE_LANG_CHINESE_EXPLAIN'					=> 'Hier kannst du auswählen ob es möglich sein soll, Beiträge zu verfassen die chinesische Zeichen enthalten. Wenn die Option <b>"JA"</b> gewählt ist wird es <b>(abhängig der Eingestellten Benutzer- bzw. Gruppenberechtigungen)</b> nicht möglich sein, Beiträge mit chinesischen Zeichen abzusenden.<br><br><b>Information:</b> Der Benutzer erhält eine entsprechende Fehlermeldung.',
	'SPSE_LANG_HINDI'							=> 'Hindi-Zeichen verbieten',
	'SPSE_LANG_HINDI_EXPLAIN'					=> 'Hier kannst du auswählen ob es möglich sein soll, Beiträge zu verfassen die Hindi-Zeichen enthalten. Wenn die Option <b>"JA"</b> gewählt ist wird es <b>(abhängig der Eingestellten Benutzer- bzw. Gruppenberechtigungen)</b> nicht möglich sein, Beiträge mit Hindi-Zeichen abzusenden.<br><br><b>Information:</b> Der Benutzer erhält eine entsprechende Fehlermeldung.',
	'SPSE_LANG_CUSTOM'							=> 'Benutzerdefinierte Eingabe aktivieren',
	'SPSE_LANG_CUSTOM_EXPLAIN'					=> 'Hier kannst du individuell Zeichen oder Zeichenketten eingeben, die nicht durch die obigen Vorgaben abgedeckt sind.',
	...
	'SSPE_REGEX_INDIVIDUAL_CHECK'				=> 'Benutzerdefinierter Regex-Code',
	'SSPE_REGEX_INDIVIDUAL_CHECK_EXPLAIN'		=> 'Hier kannst du aktivieren ob du zusätzlich noch Individuellen Regex-Code nutzen möchtest.',
	'SPSE_SETTINGS_REGEX'						=> 'Einstellungen Prüfung durch "Regex" Codierung',
	'SPSE_INVALID_REGEX'						=> 'Eingabe des "Regex" Codes',
	'SPSE_INVALID_REGEX_EXPLAIN'				=> 'Hier kannst du eine Prüfung nutzen, bei der Du vollwertigem "Regex" Code eingeben kannst.<br><br>Das Eingabeformat der regulären Ausdrücke ist mit besonderer Vorsicht zu behandeln. Ich empfehle dringend, sich vor der Eingabe regulärer Ausdrücke die Referenz zu RegEx(en) zur Hand zu nehmen.<br><br>Hier einige Beispiele wenn man z.B. Links oder andere Prüfungen vornehmen möchte:<br><br><b>Einfaches Beispiel:</b><br><b style="color: red">/</b><b style="color: green">http:</b><b style="color: red">|</b><b style="color: green">ftp:</b><b style="color: red">|</b><b style="color: green">www.</b><b style="color: red">/</b><br><br><b>Komplexeres Beispiel:<br></b> <b style="color: red">/</b><b style="color: green">(((http</b><b style="color: red">|</b><b style="color: green">https):\/\/)</b><b style="color: red">|</b><b style="color: green">(www\.))[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,}(:[0-9]+)?(\/\S*)?</b><b style="color: red">/</b><b style="color: green">i</b>',
	...
	//New1
	'SPSE_SETTINGS_VARIANT'						=> 'Einstellungen der Überprüfungsvariante',
	'SPSE_SEARCH_COMPLETE'						=> 'Überprüfungsvariante',
	'SPSE_SEARCH_COMPLETE_EXPLAIN'				=> 'Hier kannst du auswählen, welche Felder in der Eingabemaske durchsucht werden sollen. Du kannst zwischen folgenden Optionen auswählen: <br><br><b>Alle vorhandenen Eingabefelder überprüfen</b><br>&bull; Hier werden aus dem Eingabefenster alle Felder, wo eine indivduelle Zeicheneingabe möglich ist, auf unerlaubte Zeichen untersucht.<br><br><b>Nur die Eingabe des Nachrichtenfeldes überprüfen</b><br>&bull; Hierbei wird nur die Eingabe in dem Textfeld der Benachrichtigung auf individuelle verbotene Zeichen geprüft.<br><br><b>Standard: </b>Nur die Eingabe des Nachrichtenfeldes überprüfen',
	'SPSE_ALL'									=> 'Alle vorhandenen Eingabefelder überprüfen',
	'SPSE_ONLY_MESSAGE'							=> 'Nur die Eingabe des Nachrichtenfeldes überprüfen',
]);
